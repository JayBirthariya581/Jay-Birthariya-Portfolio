        ...
        226: function(e, t, a) {
            ...
            t.default = function(e) {
                ...
                return (0, r.useEffect)((function() {
                    u || (d.Z.reveal(l.current, (0, i.srConfig)()), d.Z.reveal(h.current, (0, i.srConfig)(200, 0)), p.current.forEach((function(e, t) {
                        return d.Z.reveal(e, (0, i.srConfig)(10 * t))
                    })))
                }), []), r.createElement(c.Ar, {
                    location: t
                }, r.createElement(n.q, {
                    title: "Archive"
                }), r.createElement("main", null, r.createElement("header", {
                    ref: l
                }, r.createElement("h1", {
                    className: "big-heading"
                }, "Archive"), r.createElement("p", {
                    className: "subtitle"
                }, "A list of things I've worked on")), r.createElement(s, {
                    ref: h
                }, r.createElement("table", null, r.createElement("thead", null, r.createElement("tr", null, r.createElement("th", null, "Year"), r.createElement("th", null, "Title"), r.createElement("th", {
                    className: "hide-on-mobile"
                }, "Type"), r.createElement("th", {
                    className: "hide-on-mobile"
                }, "Built with"), r.createElement("th", null, "Link"))), r.createElement("tbody", null, a.length > 0 && a.map((function(e, t) {
                    ...
                    }, "" + new Date(n).getFullYear()), r.createElement("td", {
                        className: "title"
                    }, m), r.createElement("td", {
                        className: "company hide-on-mobile"
                    }, h ? r.createElement("span", null, h) : r.createElement("span", null, "--")), r.createElement("td", {
                        className: "tech hide-on-mobile"
                    }, s.length > 0 && s.map((function(e, t) {
                        return r.createElement("span", {
                            key: t
                        }, e, "", t !== s.length - 1 && r.createElement("span", {
                            className: "separator"
                        }, "·"))
                    }))), r.createElement("td", {
                        className: "links"
                    }, r.createElement("div", null, i && r.createElement("a", {
                        href: i,
                        "aria-label": "External Link"
                    }, r.createElement(o.JO, {
                        name: "External"
                    })), l && r.createElement("a", {
                        href: l,
